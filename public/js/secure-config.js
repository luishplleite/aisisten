...
// Sistema de ocultação de logs para produção - TEMPORARIAMENTE DESABILITADO PARA DEBUG
...
class SecureConfigManager {
    ...
    // ===== UTILIDADES =====
    isAuthenticated() {
        return !!this.getCookie('timepulse_instance_token');
    }
    ...
    getInstance() {
        return {
            instanceId: this.getCookie('timepulse_instance_id'),
            instanceName: this.getCookie('timepulse_instance_name'),
            token: this.getCookie('timepulse_instance_token'),
            type: this.getCookie('timepulse_instance_type') || 'restaurant',
            userEmail: this.getCookie('timepulse_user_email'),
            restaurantId: this.getCookie('timepulse_restaurant_id')
        };
    }
}
